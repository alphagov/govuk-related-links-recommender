...
def test_extract_links_from_html(animal_welfare_html_fixture, bank_of_england_internal_link_fixture):
    ...
    assert extract_links_from_html(bank_of_england_internal_link_fixture) == ['/about/Pages/people/biographies/king']
...
def test_extract_links_from_content_details(animal_welfare_html_fixture, read_full_decision_html_fixture):
    # test string
    assert extract_links_from_content_details(animal_welfare_html_fixture) == [
        '/government/publications/poultry-on-farm-welfare',
        '/government/publications/code-of-recommendations-for-the-welfare-of-livestock-cattle',
        '/government/publications/code-of-recommendations-for-the-welfare-of-livestock-pigs',
        '/government/publications/code-of-recommendations-for-the-welfare-of-livestock-sheep',
    ...
    assert extract_links_from_content_details(
        {'content_type': 'text/html',
         'content': read_full_decision_html_fixture}
