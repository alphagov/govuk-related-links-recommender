    ...
    return [
        {'_id': '/agency-workers-your-rights',
         'expanded_links': {'ordered_related_items': [
             {'base_path': '/employment-contracts-and-conditions',
        ...
        {'_id': '/legal-aid',
         ...
         'content_id': '84f68c01-c5f3-4d20-9b31-d46fec04498c'}]


@pytest.fixture(scope="session")
def collections_links_link_list_fixture():
    return [
        {'_id': '/government/collections/your-charter-annual-reports',
         'expanded_links': {'documents': [
             {'base_path': '/government/publications/your-charter-annual-report-2017-to-2018',
        ...
        {'_id': '/government/collections/employment-relations-research-series',
         'expanded_links': {'documents': [
             {'base_path': '/government/publications/union-modernisation-fund-round-3-evaluation',
        ...
        {'_id': '/government/collections/hs2-business',
         'expanded_links': {'documents': [
             {'base_path': '/government/publications/hs2-rolling-stock-procurement',
        ...
        {'_id': '/government/collections/community-budgets',
         'expanded_links': {'documents': [
             {'base_path': '/government/publications/community-budgets--3',
        ...
        {'_id': '/government/collections/school-capital-expenditure-and-funding',
         'expanded_links': {'documents': [
             {'base_path': '/government/publications/property-data-survey-programme',
        ...
        {'_id': '/government/collections/additional-provisions-for-the-high-speed-rail-london-to-west-midlands-bill',
         'expanded_links': {'documents': [
             {'base_path': '/government/publications/additional-provision-september-2014-factsheet',
        ...
        {'_id': '/government/collections/government-commercial-function',
         'expanded_links': {'documents': [
             {'base_path': '/government/publications/commercial-operating-standards-for-government',
        ...
        {'_id': '/government/collections/new-enterprise-allowance-campaign',
         'expanded_links': {'documents': [
             {'base_path': '/government/publications/new-enterprise-allowance-campaign-promotional-videos',
        ...
        {'_id': '/government/collections/vapc-northern-ireland',
         'expanded_links': {'documents': [
             {'base_path': '/government/publications/vapc-northern-ireland-committee-members',
...
def test_convert_link_list_to_df(related_links_link_list_fixture, collections_links_link_list_fixture):
    pd_testing.assert_frame_equal(convert_link_list_to_df(related_links_link_list_fixture, 'related'),
                                  pd.read_csv(
                                      'tests/unit/related_links.csv'))

    pd_testing.assert_frame_equal(convert_link_list_to_df(collections_links_link_list_fixture, 'collection'),
...
def test_get_path_content_id_mapping(
    ...
    page_path_content_id_mapping, content_id_base_path_mapping = get_path_content_id_mappings(
