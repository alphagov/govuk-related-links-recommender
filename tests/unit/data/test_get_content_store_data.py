...
#     assert sorted(json.loads(json.dumps(get_links(mongodb.content_store_data_sample, 'related'))), key=lambda k: k['_id']) == sorted(
#         [
#             {'_id': '/getting-parole',
...
#     assert sorted(get_links(mongodb.content_store_data_sample, 'collection'), key=lambda k: k['_id']) == sorted(
#         [
